...
<main>
  <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
    <div class="col-md-5 p-lg-5 mx-auto my-5">
     ...
     <p class="lead fw-normal"  style="display: inline-block;" >O banco</p> <p style="display: inline-block;"  class="lead fw-normal q" data-period="2000" data-type='[ "feito para você.", "feito para quem você ama."]'>
        <span class="wrap"></span>

      </p>
      <br><a class="btn btn-outline-secondary" href="#">Aventure-se!</a>
    </div>
...
<script>
    ...
    window.onload = function() {
        var elements = document.getElementsByClassName('lead fw-normal q');
